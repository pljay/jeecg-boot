  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/erp/freightQuote/addErpFreightQuoteSet",
          edit: "/erp/freightQuote/editErpFreightQuoteSet",
        }
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'createBy','createTime','updateBy','updateTime','sysOrgCode','freightQuoteId','param','value','partitionSetId'))
        })
      },
      close () {
        this.$emit('close');
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            formData['freightQuoteId'] = this.mainId
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createBy','createTime','updateBy','updateTime','sysOrgCode','freightQuoteId','param','value','partitionSetId'))
      },
