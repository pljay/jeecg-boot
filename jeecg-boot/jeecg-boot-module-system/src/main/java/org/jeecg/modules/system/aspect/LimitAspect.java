...
import org.jeecg.common.exception.LimitAccessException;
import org.jeecg.common.util.erp.HttpContextUtil;
import org.jeecg.common.util.erp.IPUtil;
...
public class LimitAspect extends AspectSupport {
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        ImmutableList<String> keys = ImmutableList.of(StringUtils.join(limitAnnotation.prefix() + param+"_", key, ip));
        ...
        if (count != null && count.intValue() <= limitCount) {
            ...
            throw new LimitAccessException("Access frequency is beyond the limit");
        }
    }
