...
public class ErpShipment implements Serializable {
    ...
    /**外联订单ID*/
    @Excel(name = "外联订单ID", width = 15)
    @ApiModelProperty(value = "外联订单ID")
    private String shipmentOutboundId;
	/**客户单号*/
    ...
    @TableField(exist = false)
    private List<ErpShipmentLabel> erpShipmentLabelList;
    /**路由轨迹子表**/
    @TableField(exist =false)
    private List<ErpShipmentLog> shipmentLogList;
}
