...
public class DateUtil {
    ...
    public static String getExpireTime(String dateStr,Long jwtTimeOut) {

        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern(FULL_TIME_SPLIT_PATTERN);
        ...
        try {
            ...
            expireTime=localDateTime.plusSeconds(jwtTimeOut);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return formatFullTime(expireTime);
    }
